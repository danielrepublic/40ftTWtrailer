...
- 輪圈、輪轂、螺帽、尾燈、牌照、擋泥板、反光條、側裙與後保桿配件
- Rim, hub, nut, tail-light, license-plate, mudflap, reflective-strip, sideskirt, and rear-bumper accessories
- 素色、金屬色與自訂車架塗裝
- Solid, metallic, and custom chassis paint options
...
- Goodyear 與 Michelin 授權輪胎依對應官方 DLC 提供
- Licensed Goodyear and Michelin tire options require the corresponding official DLC
- SCS Wheels REWORK V2 為選用模組，可提供額外輪圈外觀
